...
async def test_sql_injection_prevention():
    ...
    from 01_core_server import execute_query  # Would import from actual module
...
async def test_rate_limiter_enforcement():
    ...
    from 01_core_server import RateLimiter
...
async def test_circuit_breaker_state_machine():
    ...
    from 03_client import CircuitBreaker, CircuitState
...
async def test_middleware_pipeline_execution_order():
    ...
    from 04_advanced_concepts import MiddlewarePipeline, ToolCallContext, Middleware
...
async def test_tool_chain_condition_skip():
    ...
    from 04_advanced_concepts import ToolChain, ChainStep
